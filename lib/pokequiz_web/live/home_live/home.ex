defmodule PokequizWeb.HomeLive do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-wrap">
          ...
          <header class="container px-4 lg:flex mt-10 items-center h-full lg:mt-0">
            <div class="w-full">
              <h1 class="text-4xl lg:text-6xl font-bold">
                {gettext("Catch Your Friends like Pokemon")}
              </h1>
              <div class="w-20 h-2 bg-mauve-700 my-4"></div>
              <p class="text-xl mb-10">
                {gettext(
                  "Play Pokemon Quizzes like 'Who is that Pokemon' or 'Which Pokemon is heavier'"
                )}.
              </p>
                      ...
                      <button>
                        ...
                        >
                          <.input
                            ...
                            value=""
                            minlength="6"
                            placeholder={gettext("Input Code here to join")}
                          />
                          <button class="bg-indian_red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
      ...
      <div class="max-h-100% overflow-hidden w-full h-48 object-cover sm:h-[calc(100vh-70px)] sm:w-4/12 bg-zinc-100 dark:bg-gunmetal-400">
                ...
                <ul class="grid grid-cols-1 gap-4 items-center justify-center md:justify-start animate-infinite-scroll pb-4">
                  <%= for pokemon <- @pokemon do %>
                    <li class="w-40 border border-2 border-mauve-400 rounded rounded-lg z-10">
                      <img
                        class="w-40 h-40 z-10"
                        width="40%"
                        height="40%"
                        alt={pokemon.name}
                        src={Pokequiz.Dex.Pokemon.image(pokemon)}
                      />
                    </li>
                  <% end %>
                </ul>
